...
<p align="left"><a href="contacts.php"><img width="100px" height="100px" src="image/reception.png"></a>
<div id="Menus">		
		<ul>
...
if(!$result){
die("Room is not registered!".mysqli_error());
}
if($count==1){
...
?>
 <?php
  if(isset($_POST['update']))
  {
				...
				$price=$_POST['price'];
				$status=$_POST['status'];
  $update = mysqli_query($conn,"update rooms set roomno='$roomno',category='$category', price='$price',status='$status'
  WHERE roomid='{$ctrl}'") or die(mysqli_error());
