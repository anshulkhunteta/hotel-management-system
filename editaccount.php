...
?>
 <?php
  ...
  $update = mysqli_query($conn,"update register set fname='$fname',mname='$mname', lname='$lname',sex='$sex',role='$role', phone='$phone' 
	,password='$password',username='$username'
  WHERE idno='{$idno}'") or die(mysqli_error($conn));
